...
import com.kaylves.jeasy.weixin.api.UserApi;
import com.kaylves.jeasy.weixin.entity.Group;
import com.kaylves.jeasy.weixin.entity.WXUserAuthorization;
import com.kaylves.jeasy.weixin.entity.WeiXinUser;
import com.kaylves.jeasy.weixin.entity.WeiXinUsersResult;
...
public class UserApiTest extends BaseBean
{
    ...
    {
        WeiXinUser author =UserApi.getWeiXinUserInfo("o0MlxuFdmfllHhkcah_550H24ijY",token_key);
        JSONObject json = JSONObject.fromObject( author );
        System.out.println(json);
    }
