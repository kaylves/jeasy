...
import com.kaylves.jeasy.weixin.api.MessageApi;
import com.kaylves.jeasy.weixin.context.MessageAutoReplayUtils;
import com.kaylves.jeasy.weixin.entity.MediaFileType;
import com.kaylves.jeasy.weixin.entity.MediaUploadResult;
import com.kaylves.jeasy.weixin.entity.News;
import com.kaylves.jeasy.weixin.entity.WeiXinMessage;
import com.kaylves.jeasy.weixin.exception.WeiXinException;

public class MessageApiTest extends BaseBean
{
    public static final String OPEN_ID = "o0MlxuHZVtsvrpuf6-6ntuCI0e3k";
    ...
    {
        WeiXinMessage msg = MessageApi.extractWeiXinMessage( unXml );
