...
public class TemplateApi
{
     ...
     * @exception throws [违例类型] [违例说明]
     * @see [类、类#方法、类#成员]
     * {"errcode":0,"errmsg":"ok","msgid":427964287}

     */
    public static SendTemplateResult sendTemplateMsg(TemplateMessage message,String accessToken) throws WeiXinException
    {
        ...
        SendTemplateResult msg = new SendTemplateResult();
        msg.setErrcode(json.getString("errcode"));
